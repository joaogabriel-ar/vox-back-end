...
/**
  ...
  /**
   * `prisma.serverSolicitation`: Exposes CRUD operations for the **ServerSolicitation** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more ServerSolicitations
    * const serverSolicitations = await prisma.serverSolicitation.findMany()
    * ```
    */
  get serverSolicitation(): Prisma.ServerSolicitationDelegate<ExtArgs, { omit: OmitOpts }>;

  /**
   * `prisma.serverSolicitationStatus`: Exposes CRUD operations for the **ServerSolicitationStatus** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more ServerSolicitationStatuses
    * const serverSolicitationStatuses = await prisma.serverSolicitationStatus.findMany()
    * ```
    */
  get serverSolicitationStatus(): Prisma.ServerSolicitationStatusDelegate<ExtArgs, { omit: OmitOpts }>;
